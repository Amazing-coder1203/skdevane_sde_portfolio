...
export const faq = [
  ...
  },
  {
    ...
    answer:
      "I follow a systematic approach: understanding the constraints, designing the algorithm with optimal time and space complexity, and implementing it using clean, maintainable Object-Oriented code.",
  },
  {
    id: "2",
    question: "Can I see your software projects?",
    answer:
      "Definitely! My portfolio features projects like a full-stack e-commerce platform, a real-time analytics engine, and various open-source contributions focusing on system efficiency and user experience.",
  },
  {
    id: "3",
    question: "What's your experience with Cloud and DevOps?",
    answer:
      "I've deployed applications using AWS (EC2, S3, Lambda) and am proficient with Docker, Git for version control, and CI/CD pipelines to ensure seamless software delivery.",
  },
  {
    id: "4",
    question: "How do you ensure code quality?",
    answer:
      "I prioritize writing clean, modular code following SOLID principles. I also implement unit testing and conduct thorough code reviews to maintain high standards of reliability.",
  },
  {
    id: "5",
    question: "Do you have experience with system design?",
    answer:
      "Yes, I have worked on designing both monolithic and microservices architectures, focusing on scalability, load balancing, and efficient database schema design.",
  },
  {
    id: "6",
    question: "Are you open to SDE roles?",
    answer:
      "Yes, I am actively seeking SDE internships and full-time opportunities where I can contribute to building impactful software solutions and grow as an engineer.",
  },
  {
    id: "7",
    question: "How can I get in touch?",
    answer:
      "The best way to reach me is via email at shivkumardevane47@gmail.com or through my LinkedIn profile linked in the footer.",
  },
];
...
export const socials = [
  {
    ...
    url: "https://www.linkedin.com/in/shivkumar-devane-12mar2005/",
  },
  {
    id: "1",
    title: "GitHub",
    icon: "images/socials/github_white.svg",
    url: "https://github.com/Amazing-coder1203/",
  },
  {
    id: "2",
    title: "Instagram",
